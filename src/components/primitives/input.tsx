...
const base = [
  ...
  // miku-amp has no dedicated error token — `highlight` (pink) is the
  // closest red-adjacent state marker available. Reads as "something
  // needs your attention" without inventing a new semantic colour.
  "aria-invalid:border-highlight",
].join(" ");
